...
#include <stdio.h>
#include <stdlib.h>
//new function addataposition has been added to implement the functionalty of adding node at a particularindex
struct node
{
    int data;
    struct node *next;
...
void addataposition(int index)
{
    ...
    {//1 2 3 4 5 index-2(99) 1 2 99 3 4 5
...
{   //2 4 6 99 8
    ...
    do
    {
        ...
        case 4:
        {
            printf("Enter the index where element should be inserted");
            scanf("%d", &data);
            addataposition(data);
            break;
        }
